...
$( document ).ready(function() {
    ...
    $('#yourtxid').on('click', 'a', function(){
	 ...
	 alert("not implimenteed " +  $(this).attr('href'))
     return false;
   });
   ...
   // $("#pinButton").click(function () {
        ...
        var data = localStorage.getItem("passphrase")
            var decrypted = CryptoJS.AES.decrypt(data, pin, { format: JsonFormatter });          
   ...
   $(document).on("click", '#encryptPasswordButton', function (event) 
    {
        var data = localStorage.getItem("passphrase")     
            ...
            localStorage.setItem('passphrase', encrypted)
